!function (e, t) {
  ...
  return function (e) {
    ...
    var n = r(2), s = i(n);
    r(33);
    var o = r(37), a = i(o), u = r(40), c = i(u), l = [a.default, c.default, function () {
    ...
    var a = function () {
      ...
      return o(t, e), a(t, [{
        key: "render", value: function () {
          var e = this.props, t = e.getComponent, r = e.specSelectors, i = t("Container"), n = t("Row"), s = t("Col"), o = t("Topbar", !0), a = t("BaseLayout", !0), u = t("onlineValidatorBadge", !0), l = r.loadingStatus();
          return c.default.createElement(i, {className: "swagger-ui"}, o ? c.default.createElement(o, null) : null, "loading" === l && c.default.createElement("div", {className: "info"}, c.default.createElement("h4", {className: "title"}, "Loading...")), "failed" === l && c.default.createElement("div", {className: "info"}, c.default.createElement("h4", {className: "title"}, "Failed to load spec.")), "failedConfig" === l && c.default.createElement("div", {
              className: "info",
              style: {maxWidth: "880px", marginLeft: "auto", marginRight: "auto", textAlign: "center"}
            }, c.default.createElement("h4", {className: "title"}, "Failed to load config.")), !l || "success" === l && c.default.createElement(a, null), c.default.createElement(n, null, c.default.createElement(s, null, c.default.createElement(u, null))))
        }
      }]), t
    }(c.default.Component);
    l.propTypes = {
    ...
    "use strict";
    var i = r(5), n = r(6), s = r(19), o = r(22), a = r(23), u = r(25), c = r(10), l = r(26), h = r(31), p = r(32), f = (r(12), c.createElement), d = c.createFactory, m = c.cloneElement, g = i, x = {
      Children: {
        map: n.map,
        forEach: n.forEach,
        count: n.count,
        toArray: n.toArray,
        only: p
      }, Component: s, PureComponent: o, createElement: f, cloneElement: m, isValidElement: c.isValidElement, PropTypes: l, createClass: a.createClass, createFactory: d, createMixin: function (e) {
        return e
      }, DOM: u, version: h, __spread: g
    };
    e.exports = x
  }, function (e, t) {/*
   object-assign
   ...
   */
    ...
    function u(e, t, r) {
      var n = e.result, s = e.keyPrefix, o = e.func, a = e.context, u = o.call(a, t, e.count++);
    ...
    var d = r(7), m = r(10), g = r(13), x = r(16), y = d.twoArgumentPooler, D = d.fourArgumentPooler, b = /\/+/g;
    n.prototype.destructor = function () {
      this.func = null, this.context = null, this.count = 0
    }, d.addPoolingTo(n, y), a.prototype.destructor = function () {
      this.result = null, this.keyPrefix = null, this.func = null, this.context = null, this.count = 0
    }, d.addPoolingTo(a, D);
    var v = {forEach: o, map: l, mapIntoWithKeyPrefixInternal: c, count: p, toArray: f};
    e.exports = v
  }, function (e, t, r) {
    "use strict";
    var i = r(8), n = (r(9), function (e) {
      var t = this;
    ...
    }, c = 10, l = n, h = function (e, t) {
      var r = e;
      return r.instancePool = [], r.getPooled = t || l, r.poolSize || (r.poolSize = c), r.release = u, r
    }, p = {addPoolingTo: h, oneArgumentPooler: n, twoArgumentPooler: s, threeArgumentPooler: o, fourArgumentPooler: a};
    e.exports = p
  }, function (e, t) {
    "use strict";
    function r(e) {
    ...
    var s = r(5), o = r(11), a = (r(12), r(14), Object.prototype.hasOwnProperty), u = r(15), c = {key: !0, ref: !0, __self: !0, __source: !0}, l = function (e, t, r, i, n, s, o) {
      var a = {$$typeof: u, type: e, key: t, ref: r, props: o, _owner: s};
      return a
    };
    l.createElement = function (e, t, r) {
      var s, u = {}, h = null, p = null, f = null, d = null;
      if (null != t) {
      ...
      if (1 === m)u.children = r; else if (m > 1) {
      ...
      var u, h = s({}, e.props), p = e.key, f = e.ref, d = e._self, m = e._source, g = e._owner;
      if (null != t) {
      ...
      if (1 === y)h.children = r; else if (y > 1) {
    ...
    function n(e, t, r, s) {
      ...
      var f, d, m = 0, g = "" === t ? l : t + h;
      if (Array.isArray(e))for (var x = 0; x < e.length; x++)f = e[x], d = g + i(f, x), m += n(f, d, r, s); else {
        var y = u(e);
        if (y) {
          var D, b = y.call(e);
          if (y !== e.entries)for (var v = 0; !(D = b.next()).done;)f = D.value, d = g + i(f, v++), m += n(f, d, r, s); else for (; !(D = b.next()).done;) {
            var w = D.value;
    ...
    var o = r(8), a = (r(11), r(15)), u = r(17), c = (r(9), r(18)), l = (r(12), "."), h = ":";
    e.exports = s
  }, function (e, t) {
    "use strict";
    function r(e) {
    ...
    var i = "function" == typeof Symbol && Symbol.iterator, n = "@@iterator";
    e.exports = r
  }, function (e, t) {
    "use strict";
    function r(e) {
      var t = /[=:]/g, r = {"=": "=0", ":": "=2"}, i = ("" + e).replace(t, function (e) {
        return r[e]
      });
      return "$" + i
    }
    ...
    function i(e) {
      var t = /(=0|=2)/g, r = {"=0": "=", "=2": ":"}, i = "." === e[0] && "$" === e[1] ? e.substring(2) : e.substring(1);
    ...
    var s = r(5), o = r(19), a = r(20), u = r(21);
    ...
    function s(e, t) {
      if (t) {
        ...
        for (var s in t)if (t.hasOwnProperty(s) && s !== y) {
          var o = t[s], a = r.hasOwnProperty(s);
          if (n(a, s), v.hasOwnProperty(s))v[s](e, o); else {
            var l = b.hasOwnProperty(s), h = "function" == typeof o, f = h && !l && !a && t.autobind !== !1;
            if (f)i.push(s, o), r[s] = o; else if (a) {
              var d = b[s];
    ...
    function u(e, t) {
      return function () {
        var r = e.apply(this, arguments), i = t.apply(this, arguments);
        if (null == r)return i;
        if (null == i)return r;
        var n = {};
    ...
    var p = r(8), f = r(5), d = r(19), m = r(10), g = (r(24), r(20)), x = r(21), y = (r(9), r(12), "mixins"), D = [], b = {
      mixins: "DEFINE_MANY",
      statics: "DEFINE_MANY",
    ...
    "use strict";
    var i = r(10), n = i.createFactory, s = {
      a: n("a"),
      abbr: n("abbr"),
      address: n("address"),
      area: n("area"),
    ...
    "use strict";
    var i = r(10), n = i.isValidElement, s = r(27);
    e.exports = s(n)
  }, function (e, t, r) {
    "use strict";
    var i = r(28);
    ...
    "use strict";
    var i = r(13), n = r(9), s = r(12), o = r(29), a = r(30);
    e.exports = function (e, t) {
      ...
      function l(e) {
        function r(r, i, s, a, u, l, h) {
          if (a = a || T, l = l || s, h !== o)if (t)n(!1, "Calling PropTypes validators directly is not supported by the `prop-types` package. Use `PropTypes.checkPropTypes()` to call them. Read more at http://fb.me/use-check-prop-types"); else;
      ...
      function g(e) {
        function t(t, r, i, n, s) {
          for (var o = t[r], a = 0; a < e.length; a++)if (u(o, e[a]))return null;
      ...
      function v(t) {
        switch (typeof t) {
          ...
          case"object":
            ...
            var n, s = i.call(t);
            if (i !== t.entries) {
              for (; !(n = s.next()).done;)if (!v(n.value))return !1
            } else for (; !(n = s.next()).done;) {
              var o = n.value;
              if (o && !v(o[1]))return !1
            }
            return !0;
      ...
      var S = "function" == typeof Symbol && Symbol.iterator, F = "@@iterator", T = "<<anonymous>>", B = {
        array: h("array"),
        bool: h("boolean"),
        func: h("function"),
        number: h("number"),
    ...
    function n(e) {
      for (var t = [], r = {}, i = 0; i < e.length; i++) {
        var n = e[i], s = n[0], o = n[1], a = n[2], u = n[3], c = {css: o, media: a, sourceMap: u};
    ...
    function s(e, t) {
      var r = g(), i = D[D.length - 1];
      if ("top" === e.insertAt)i ? i.nextSibling ? r.insertBefore(t, i.nextSibling) : r.appendChild(t) : r.insertBefore(t, r.firstChild), D.push(t); else {
    ...
    function h(e, t) {
      ...
      t.sourceMap;
      if (i && e.setAttribute("media", i), e.styleSheet)e.styleSheet.cssText = r; else {
    ...
    function p(e, t) {
      var r = t.css, i = (t.media, t.sourceMap);
      i && (r += "\n/*# sourceMappingURL=data:application/json;base64," + btoa(unescape(encodeURIComponent(JSON.stringify(i)))) + " */");
      var n = new Blob([r], {type: "text/css"}), s = e.href;
    ...
    var a = function () {
    ...
    }(), u = r(3), c = i(u), l = r(39), h = i(l), p = function (e) {
      function t(e, r) {
        n(this, t);
        ...
        }, i.state = {url: e.specSelectors.url()}, i
      }
      ...
      return o(t, e), a(t, [{
        ...
        key: "render", value: function () {
          var e = this.props, t = e.getComponent, r = e.specSelectors, i = t("Button"), n = t("Link"), s = "loading" === r.loadingStatus(), o = "failed" === r.loadingStatus(), a = {};
          return o && (a.color = "red"), s && (a.color = "#aaa"), c.default.createElement("div", {className: "topbar"}, c.default.createElement("div", {className: "wrapper"}, c.default.createElement("div", {className: "topbar-wrapper"}, c.default.createElement(n, {
            href: "#",
            title: "Swagger UX"
            ...
            disabled: s,
            style: a
          }), c.default.createElement(i, {className: "download-url-button", onClick: this.downloadUrl}, "Explore")))))
        }
      }]), t
    }(c.default.Component);
    t.default = p, p.propTypes = {specSelectors: u.PropTypes.object.isRequired, specActions: u.PropTypes.object.isRequired, getComponent: u.PropTypes.func.isRequired}
  }, function (e, t) {
    ...
    var s = r(41), o = i(s), a = r(76), u = i(a), c = function (e, t) {
      try {
    ...
    function g(e, t, r, i) {
      var n, s, o, a;
      if (t < r) {
        if (a = e.input.slice(t, r), i)for (n = 0, s = a.length; n < s; n += 1)o = a.charCodeAt(n), 9 === o || 32 <= o && o <= 1114111 || d(e, "expected valid JSON character"); else Q.test(a) && d(e, "the stream contains non-printable characters");
        e.result += a
      }
    }
    ...
    function y(e, t, r, i, n, s, o, a) {
      var u, c;
      if (n = String(n), null === t && (t = {}), "tag:yaml.org,2002:merge" === i)if (Array.isArray(s))for (u = 0, c = s.length; u < c; u += 1)x(e, t, s[u], r); else x(e, t, s, r); else e.json || K.call(r, n) || !K.call(t, n) || (e.line = o || e.line, e.position = a || e.position, d(e, "duplicated mapping key")), t[n] = s, delete r[n];
      return t
    }
    ...
    function E(e, t, r) {
      var a, u, c, l, h, p, f, d, m, x = e.kind, y = e.result;
    ...
    function k(e, t) {
      ...
      for (e.kind = "scalar", e.result = "", e.position++, n = s = e.position; 0 !== (r = e.input.charCodeAt(e.position));)if (39 === r) {
    ...
    function A(e, t) {
      ...
      for (e.kind = "scalar", e.result = "", e.position++, r = n = e.position; 0 !== (l = e.input.charCodeAt(e.position));) {
        ...
        if (92 === l) {
          if (g(e, r, e.position, !0), l = e.input.charCodeAt(++e.position), i(l))b(e, !1, t); else if (l < 256 && ne[l])e.result += se[l], e.position++; else if ((c = u(l)) > 0) {
    ...
    function C(e, t) {
      var r, i, n, o, a, u, c, l, h, p, f, m = !0, g = e.tag, x = e.anchor, D = {};
      if (f = e.input.charCodeAt(e.position), 91 === f)o = 93, c = !1, i = []; else {
        if (123 !== f)return !1;
        o = 125, c = !0, i = {}
      }
    ...
    function S(e, t) {
      var r, s, o, a, u = V, l = !1, h = !1, p = t, f = 0, m = !1;
      if (a = e.input.charCodeAt(e.position), 124 === a)s = !1; else {
        if (62 !== a)return !1;
        s = !0
      }
      for (e.kind = "scalar", e.result = ""; 0 !== a;)if (a = e.input.charCodeAt(++e.position), 43 === a || 45 === a)V === u ? u = 43 === a ? Z : $ : d(e, "repeat of a chomping mode identifier"); else {
        if (!((o = c(a)) >= 0))break;
      ...
      if (n(a)) {
        ...
        if (35 === a)do a = e.input.charCodeAt(++e.position); while (!i(a) && 0 !== a)
      }
      for (; 0 !== a;) {
        for (D(e), e.lineIndent = 0, a = e.input.charCodeAt(e.position); (!h || e.lineIndent < p) && 32 === a;)e.lineIndent++, a = e.input.charCodeAt(++e.position);
        if (!h && e.lineIndent > p && (p = e.lineIndent), i(a))f++; else {
          if (e.lineIndent < p) {
    ...
    function F(e, t) {
      var r, i, n, o = e.tag, a = e.anchor, u = [], c = !1;
      for (null !== e.anchor && (e.anchorMap[e.anchor] = u), n = e.input.charCodeAt(e.position); 0 !== n && 45 === n && (i = e.input.charCodeAt(e.position + 1), s(i));)if (c = !0, e.position++, b(e, !0, -1) && e.lineIndent <= t)u.push(null), n = e.input.charCodeAt(e.position); else if (r = e.line, P(e, t, q, !1, !0), u.push(e.result), b(e, !0, -1), n = e.input.charCodeAt(e.position), (e.line === r || e.lineIndent > t) && 0 !== n)d(e, "bad indentation of a sequence entry"); else if (e.lineIndent < t)break;
      return !!c && (e.tag = o, e.anchor = a, e.kind = "sequence", e.result = u, !0)
    }

    function T(e, t, r) {
      var i, o, a, u, c, l = e.tag, h = e.anchor, p = {}, f = {}, m = null, g = null, x = null, D = !1, v = !1;
      for (null !== e.anchor && (e.anchorMap[e.anchor] = p), c = e.input.charCodeAt(e.position); 0 !== c;) {
        if (i = e.input.charCodeAt(e.position + 1), a = e.line, u = e.position, 63 !== c && 58 !== c || !s(i)) {
          ...
          if (e.line === a) {
            ...
            if (58 === c)c = e.input.charCodeAt(++e.position), s(c) || d(e, "a whitespace character is expected after the key-value separator within a block mapping"), D && (y(e, p, f, m, g, null), m = g = x = null), v = !0, D = !1, o = !1, m = e.tag, g = e.result; else {
        ...
        if ((e.line === a || e.lineIndent > t) && (P(e, t, G, !0, o) && (D ? g = e.result : x = e.result), D || (y(e, p, f, m, g, x, a, u), m = g = x = null), b(e, !0, -1), c = e.input.charCodeAt(e.position)), e.lineIndent > t && 0 !== c)d(e, "bad indentation of a mapping entry"); else if (e.lineIndent < t)break
      }
    ...
    function P(e, t, r, i, n) {
      var s, o, a, u, c, l, h, p, f = 1, m = !1, g = !1;
      if (null !== e.listener && e.listener("open", e), e.tag = null, e.anchor = null, e.kind = null, e.result = null, s = o = a = G === r || q === r, i && b(e, !0, -1) && (m = !0, e.lineIndent > t ? f = 1 : e.lineIndent === t ? f = 0 : e.lineIndent < t && (f = -1)), 1 === f)for (; B(e) || N(e);)b(e, !0, -1) ? (m = !0, a = s, e.lineIndent > t ? f = 1 : e.lineIndent === t ? f = 0 : e.lineIndent < t && (f = -1)) : a = !1;
      if (a && (a = m || n), 1 !== f && G !== r || (h = W === r || H === r ? t : t + 1, p = e.position - e.lineStart, 1 === f ? a && (F(e, p) || T(e, p, h)) || C(e, h) ? g = !0 : (o && S(e, h) || k(e, h) || A(e, h) ? g = !0 : I(e) ? (g = !0, null === e.tag && null === e.anchor || d(e, "alias node should not have any properties")) : E(e, h, W === r) && (g = !0, null === e.tag && (e.tag = "?")), null !== e.anchor && (e.anchorMap[e.anchor] = e.result)) : 0 === f && (g = a && F(e, p))), null !== e.tag && "!" !== e.tag)if ("?" === e.tag) {
    ...
    function s(e, t) {
      var r, i, n, s;
      if (t)for (s = Object.keys(t), r = 0, i = s.length; r < i; r += 1)n = s[r], e[n] = t[n];
      return e
    }
    ...
    i.prototype.getSnippet = function (e, t) {
      ...
      for (e = e || 4, t = t || 75, r = "", i = this.position; i > 0 && "\0\r\n\u2028\u2029".indexOf(this.buffer.charAt(i - 1)) === -1;)if (i -= 1, this.position - i > t / 2 - 1) {
        r = " ... ", i += 5;
        break
      }
      for (s = "", o = this.position; o < this.buffer.length && "\0\r\n\u2028\u2029".indexOf(this.buffer.charAt(o)) === -1;)if (o += 1, o - this.position > t / 2 - 1) {
        s = " ... ", o -= 5;
        break
      }
    ...
    "use strict";
    var i = r(48);
    e.exports = new i({include: [r(50)], implicit: [r(60), r(61)], explicit: [r(62), r(67), r(68), r(69)]})
  }, function (e, t, r) {
    "use strict";
    function i(e, t, r) {
      var n = [];
    ...
    function n() {
      ...
      var t, r, i = {scalar: {}, sequence: {}, mapping: {}, fallback: {}};
    ...
    var s = r(45), o = ["kind", "resolve", "construct", "instanceOf", "predicate", "represent", "defaultStyle", "styleAliases"], a = ["scalar", "sequence", "mapping"];
    e.exports = n
  }, function (e, t, r) {
    "use strict";
    var i = r(48);
    e.exports = new i({include: [r(51)]})
  }, function (e, t, r) {
    "use strict";
    var i = r(48);
    e.exports = new i({include: [r(52)], implicit: [r(56), r(57), r(58), r(59)]})
  }, function (e, t, r) {
    "use strict";
    var i = r(48);
    e.exports = new i({explicit: [r(53), r(54), r(55)]})
  }, function (e, t, r) {
    "use strict";
    var i = r(49);
    ...
    e.exports = new o("tag:yaml.org,2002:null", {
      kind: "scalar", resolve: i, construct: n, predicate: s, represent: {
        canonical: function () {
          return "~"
        }, lowercase: function () {
          return "null"
    ...
    function o(e) {
      if (null === e)return !1;
      var t, r = e.length, o = 0, a = !1;
      if (!r)return !1;
      if (t = e[o], "-" !== t && "+" !== t || (t = e[++o]), "0" === t) {
        if (o + 1 === r)return !0;
        if (t = e[++o], "b" === t) {
          for (o++; o < r; o++)if (t = e[o], "_" !== t) {
            if ("0" !== t && "1" !== t)return !1;
            a = !0
          }
          return a && "_" !== t
    ...
    e.exports = new l("tag:yaml.org,2002:int", {
      kind: "scalar", resolve: o, construct: a, predicate: u, represent: {
        binary: function (e) {
    ...
    var a = r(44), u = r(49), c = new RegExp("^(?:[-+]?(?:0|[1-9][0-9_]*)(?:\\.[0-9_]*)?(?:[eE][-+]?[0-9]+)?|\\.[0-9_]+(?:[eE][-+]?[0-9]+)?|[-+]?[0-9][0-9_]*(?::[0-5]?[0-9])+\\.[0-9_]*|[-+]?\\.(?:inf|Inf|INF)|\\.(?:nan|NaN|NAN))$"), l = /^[-+]?[0-9]+e/;
    e.exports = new u("tag:yaml.org,2002:float", {kind: "scalar", resolve: i, construct: n, predicate: o, represent: s, defaultStyle: "lowercase"})
  }, function (e, t, r) {
    "use strict";
    function i(e) {
    ...
    function n(e) {
      var t, r, i, n, s, o, c, l, h, p, f = 0, d = null;
    ...
    var o = r(49), a = new RegExp("^([0-9][0-9][0-9][0-9])-([0-9][0-9])-([0-9][0-9])$"), u = new RegExp("^([0-9][0-9][0-9][0-9])-([0-9][0-9]?)-([0-9][0-9]?)(?:[Tt]|[ \\t]+)([0-9][0-9]?):([0-9][0-9]):([0-9][0-9])(?:\\.([0-9]*))?(?:[ \\t]*(Z|([-+])([0-9][0-9]?)(?::([0-9][0-9]))?))?$");
    e.exports = new o("tag:yaml.org,2002:timestamp", {kind: "scalar", resolve: i, construct: n, instanceOf: Date, represent: s})
  }, function (e, t, r) {
    "use strict";
    function i(e) {
      return "<<" === e || null === e
    ...
    var n = r(49);
    e.exports = new n("tag:yaml.org,2002:merge", {kind: "scalar", resolve: i})
  }, function (e, t, r) {
    function i(e) {
      if (null === e)return !1;
      var t, r, i = 0, n = e.length, s = c;
      for (r = 0; r < n; r++)if (t = s.indexOf(e.charAt(r)), !(t > 64)) {
        if (t < 0)return !1;
        i += 6
      }
      return i % 8 === 0
    ...
    var u = r(49), c = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=\n\r";
    e.exports = new u("tag:yaml.org,2002:binary", {kind: "scalar", resolve: i, construct: n, predicate: o, represent: s})
  }, function (e, t, r) {
    (function (e) {/*!
     ...
     */
      ...
      function l(e, t) {
        if (u(t), e = s(e, t < 0 ? 0 : 0 | m(t)), !o.TYPED_ARRAY_SUPPORT)for (var r = 0; r < t; ++r)e[r] = 0;
        return e
      }
      ...
      function v(e, t, r, i, n) {
        ...
        if (n) {
          var l = -1;
          for (c = r; c < a; c++)if (s(e, c) === s(t, l === -1 ? 0 : c - l)) {
            if (l === -1 && (l = c), c - l + 1 === u)return l * o
          } else l !== -1 && (c -= c - l), l = -1
        } else for (r + u > a && (r = a - u), c = r; c >= 0; c--) {
          for (var h = !0, p = 0; p < u; p++)if (s(e, c + p) !== s(t, p)) {
            h = !1;
            break
          }
          if (h)return c
      ...
      t.Buffer = o, t.SlowBuffer = g, t.INSPECT_MAX_BYTES = 50, o.TYPED_ARRAY_SUPPORT = void 0 !== e.TYPED_ARRAY_SUPPORT ? e.TYPED_ARRAY_SUPPORT : i(), t.kMaxLength = n(), o.poolSize = 8192, o._augment = function (e) {
        ...
        for (var s = n - i, a = r - t, u = Math.min(s, a), c = this.slice(i, n), l = e.slice(t, r), h = 0; h < u; ++h)if (c[h] !== l[h]) {
          s = c[h], a = l[h];
          break
        }
      ...
      o.prototype.slice = function (e, t) {
        ...
        if ("number" == typeof e)for (s = t; s < r; ++s)this[s] = e; else {
          var a = o.isBuffer(e) ? e : K(new o(e, i).toString()), u = a.length;
    ...
    t.read = function (e, t, r, i, n) {
      var s, o, a = 8 * n - i - 1, u = (1 << a) - 1, c = u >> 1, l = -7, h = r ? n - 1 : 0, p = r ? -1 : 1, f = e[t + h];
      ...
      var o, a, u, c = 8 * s - n - 1, l = (1 << c) - 1, h = l >> 1, p = 23 === n ? Math.pow(2, -24) - Math.pow(2, -77) : 0, f = i ? 0 : s - 1, d = i ? 1 : -1, m = t < 0 || 0 === t && 1 / t < 0 ? 1 : 0;
    ...
    var s = r(49), o = Object.prototype.hasOwnProperty, a = Object.prototype.toString;
    e.exports = new s("tag:yaml.org,2002:omap", {kind: "sequence", resolve: i, construct: n})
  }, function (e, t, r) {
    "use strict";
    function i(e) {
      if (null === e)return !0;
    ...
    var s = r(49), o = Object.prototype.toString;
    e.exports = new s("tag:yaml.org,2002:pairs", {kind: "sequence", resolve: i, construct: n})
  }, function (e, t, r) {
    "use strict";
    function i(e) {
      if (null === e)return !0;
    ...
    var s = r(49), o = Object.prototype.hasOwnProperty;
    e.exports = new s("tag:yaml.org,2002:set", {kind: "mapping", resolve: i, construct: n})
  }, function (e, t, r) {
    "use strict";
    var i = r(48);
    e.exports = i.DEFAULT = new i({include: [r(47)], explicit: [r(71), r(72), r(73)]})
  }, function (e, t, r) {
    "use strict";
    function i() {
      return !0
    ...
    var a = r(49);
    e.exports = new a("tag:yaml.org,2002:js/undefined", {kind: "scalar", resolve: i, construct: n, predicate: o, represent: s})
  }, function (e, t, r) {
    "use strict";
    function i(e) {
      if (null === e)return !1;
      if (0 === e.length)return !1;
      var t = e, r = /\/([gim]*)$/.exec(e), i = "";
      if ("/" === t[0]) {
    ...
    var a = r(49);
    e.exports = new a("tag:yaml.org,2002:js/regexp", {kind: "scalar", resolve: i, construct: n, predicate: o, represent: s})
  }, function (e, t, r) {
    function i(e) {
      if (null === e)return !1;
      try {
        var t = "(" + e + ")", r = a.parse(t, {range: !0});
    ...
    function n(e) {
      var t, r = "(" + e + ")", i = a.parse(r, {range: !0}), n = [];
    ...
    var u = r(49);
    e.exports = new u("tag:yaml.org,2002:js/function", {kind: "scalar", resolve: i, construct: n, predicate: o, represent: s})
  }, function (e, t, r) {
    !function (t, r) {
      e.exports = r()
    }(this, function () {
      return function (e) {
        ...
        "use strict";
        function i(e, t, r) {
          var i = null, n = function (e, t) {
            r && r(e, t), i && i.visit(e, t)
          }, u = "function" == typeof r ? n : null, c = !1;
          if (t) {
        ...
        var i = r(2), n = function () {
          ...
          return e.prototype.insertInnerComments = function (e, t) {
            ...
            if (!(e.type === i.Syntax.Program && e.body.length > 0)) {
              ...
              var r = this.findTrailingComments(e, t), n = this.findLeadingComments(e, t);
              n.length > 0 && (e.leadingComments = n), r.length > 0 && (e.trailingComments = r), this.stack.push({node: e, start: t.start.offset})
            }
          }, e.prototype.visitComment = function (e, t) {
            var r = "L" === e.type[0] ? "Line" : "Block", i = {type: r, value: e.value};
            if (e.range && (i.range = e.range), e.loc && (i.loc = e.loc), this.comments.push(i), this.attach) {
              var n = {comment: {type: r, value: e.value, range: [t.start.offset, t.end.offset]}, start: t.start.offset};
        ...
        "use strict";
        var i = r(4), n = r(5), s = r(6), o = r(7), a = r(8), u = r(2), c = r(10), l = "ArrowParameterPlaceHolder", h = function () {
          function e(e, t, r) {
            void 0 === t && (t = {}), this.config = {
              ...
              ")": 0, ";": 0, ",": 0, "=": 0, "]": 0, "||": 1, "&&": 2, "|": 3,
              "^": 4, "&": 5, "==": 6, "!=": 6, "===": 6, "!==": 6, "<": 7, ">": 7, "<=": 7, ">=": 7, "<<": 8, ">>": 8, ">>>": 8, "+": 9, "-": 9, "*": 11, "/": 11, "%": 11
            ...
            }, this.tokens = [], this.startMarker = {index: 0, lineNumber: this.scanner.lineNumber, lineStart: 0}, this.lastMarker = {
              index: 0,
              lineNumber: this.scanner.lineNumber,
              lineStart: 0
            }, this.nextToken(), this.lastMarker = {index: this.scanner.index, lineNumber: this.scanner.lineNumber, lineStart: this.scanner.lineStart}
          }

          return e.prototype.throwError = function (e) {
            for (var t = [], r = 1; r < arguments.length; r++)t[r - 1] = arguments[r];
            var n = Array.prototype.slice.call(arguments, 1), s = e.replace(/%(\d)/g, function (e, t) {
              return i.assert(t < n.length, "Message reference must be in range"), n[t]
            }), o = this.lastMarker.index, a = this.lastMarker.lineNumber, u = this.lastMarker.index - this.lastMarker.lineStart + 1;
            throw this.errorHandler.createError(o, a, u, s)
          }, e.prototype.tolerateError = function (e) {
            for (var t = [], r = 1; r < arguments.length; r++)t[r - 1] = arguments[r];
            var n = Array.prototype.slice.call(arguments, 1), s = e.replace(/%(\d)/g, function (e, t) {
              return i.assert(t < n.length, "Message reference must be in range"), n[t]
            }), o = this.lastMarker.index, a = this.scanner.lineNumber, u = this.lastMarker.index - this.lastMarker.lineStart + 1;
            ...
            if (e ? (t || (i = e.type === o.Token.EOF ? n.Messages.UnexpectedEOS : e.type === o.Token.Identifier ? n.Messages.UnexpectedIdentifier : e.type === o.Token.NumericLiteral ? n.Messages.UnexpectedNumber : e.type === o.Token.StringLiteral ? n.Messages.UnexpectedString : e.type === o.Token.Template ? n.Messages.UnexpectedTemplate : n.Messages.UnexpectedToken, e.type === o.Token.Keyword && (this.scanner.isFutureReservedWord(e.value) ? i = n.Messages.UnexpectedReserved : this.context.strict && this.scanner.isStrictModeReservedWord(e.value) && (i = n.Messages.StrictReservedWord))), r = e.type === o.Token.Template ? e.value.raw : e.value) : r = "ILLEGAL", i = i.replace("%0", r), e && "number" == typeof e.lineNumber) {
              var s = e.start, a = e.lineNumber, u = e.start - this.lastMarker.lineStart + 1;
              return this.errorHandler.createError(s, a, u, i)
            }
            var s = this.lastMarker.index, a = this.lastMarker.lineNumber, u = s - this.lastMarker.lineStart + 1;
            return this.errorHandler.createError(s, a, u, i)
            ...
            if (this.config.comment) {
              ...
              if (e.length > 0 && this.delegate)for (var t = 0; t < e.length; ++t) {
                ...
                var n = {start: {line: r.loc.start.line, column: r.loc.start.column, offset: r.range[0]}, end: {line: r.loc.end.line, column: r.loc.end.column, offset: r.range[1]}};
                this.delegate(i, n)
              }
            ...
            return t = {
              ...
              start: {line: this.startMarker.lineNumber, column: this.startMarker.index - this.startMarker.lineStart},
            ...
            return {index: this.startMarker.index, line: this.startMarker.lineNumber, column: this.startMarker.index - this.startMarker.lineStart}
            ...
            if (this.config.range && (t.range = [e.index, this.lastMarker.index]), this.config.loc && (t.loc = {
                ...
                end: {line: this.lastMarker.lineNumber, column: this.lastMarker.index - this.lastMarker.lineStart}
              }, this.config.source && (t.loc.source = this.config.source)), this.delegate) {
              var r = {
                start: {line: e.line, column: e.column, offset: e.index},
                end: {line: this.lastMarker.lineNumber, column: this.lastMarker.index - this.lastMarker.lineStart, offset: this.lastMarker.index}
              };
              this.delegate(t, r)
            }
            return t
            ...
            var t = this.context.isBindingElement, r = this.context.isAssignmentTarget, i = this.context.firstCoverInitializedNameError;
            ...
            var t = this.context.strict, r = this.isolateCoverGrammar(this.parseFunctionSourceElements);
            ...
            var e = !1, t = this.createNode(), r = this.context.allowYield;
            ...
            var e = this.createNode(), t = this.nextToken(), r = null;
            switch (t.type) {
              case o.Token.StringLiteral:
              case o.Token.NumericLiteral:
            ...
            var t, r, i, s = this.createNode(), a = this.lookahead, u = !1, l = !1, h = !1;
            ...
            var e = this.createNode();
            this.expect("{");
            for (var t = [], r = {value: !1}; !this.match("}");)t.push(this.parseObjectProperty(r)), this.match("}") || this.expectCommaSeparator();
            ...
            var e = this.createNode(), t = this.nextToken(), r = {raw: t.value.raw, cooked: t.value.cooked};
            ...
            var e = this.createNode(), t = [], r = [], i = this.parseTemplateHead();
            ...
            var e;
            if (this.expect("("), this.match(")"))this.nextToken(), this.match("=>") || this.expect("=>"), e = {type: l, params: []}; else {
              var t = this.lookahead, r = [];
              if (this.match("..."))e = this.parseRestElement(r), this.expect(")"), this.match("=>") || this.expect("=>"), e = {type: l, params: [e]}; else {
                var i = !1;
                ...
                if (!i) {
                  if (this.expect(")"), this.match("=>") && (e.type === u.Syntax.Identifier && "yield" === e.name && (i = !0, e = {type: l, params: [e]}), !i)) {
                    if (this.context.isBindingElement || this.throwUnexpectedToken(this.lookahead), e.type === u.Syntax.SequenceExpression)for (var s = 0; s < e.expressions.length; s++)this.reinterpretExpressionAsPattern(e.expressions[s]); else this.reinterpretExpressionAsPattern(e);
            ...
            var r;
            if (this.match("."))if (this.nextToken(), this.lookahead.type === o.Token.Identifier && this.context.inFunctionBody && "target" === this.lookahead.value) {
              var n = this.parseIdentifierName();
              r = new c.MetaProperty(t, n)
            } else this.throwUnexpectedToken(this.lookahead); else {
              var s = this.isolateCoverGrammar(this.parseLeftHandSideExpression), a = this.match("(") ? this.parseArguments() : [];
            ...
            var e = this.lookahead, t = this.context.allowIn;
            ...
            if (this.match("++") || this.match("--")) {
              var r = this.startNode(t), i = this.nextToken();
              ...
              var a = this.nextToken().value, s = !1;
            ...
            if (this.match("+") || this.match("-") || this.match("~") || this.match("!") || this.matchKeyword("delete") || this.matchKeyword("void") || this.matchKeyword("typeof")) {
              var t = this.startNode(this.lookahead), r = this.nextToken();
            ...
            if (t.type !== u.Syntax.UnaryExpression && this.match("**")) {
              ...
              var r = t, i = this.isolateCoverGrammar(this.parseExponentiationExpression);
            ...
            var e = this.lookahead, t = this.inheritCoverGrammar(this.parseExponentiationExpression), r = this.lookahead, i = this.binaryPrecedence(r);
            if (i > 0) {
            ...
            if (this.context.strict || !this.context.allowYield)for (var i = 0; i < r.length; ++i) {
              var s = r[i];
            ...
            return {params: r, stricted: t.stricted, firstRestricted: t.firstRestricted, message: t.message}
            ...
            if (!this.context.allowYield && this.matchKeyword("yield"))e = this.parseYieldExpression(); else {
              ...
              if (e = this.parseConditionalExpression(), e.type === l || this.match("=>")) {
                ...
                if (i) {
                  ...
                  var s = this.context.strict, o = this.context.allowYield;
                  this.context.allowYield = !0;
                  var a = this.startNode(t);
                  this.expect("=>");
                  var h = this.match("{") ? this.parseFunctionSourceElements() : this.isolateCoverGrammar(this.parseAssignmentExpression), p = h.type !== u.Syntax.BlockStatement;
            ...
            var r = this.createNode(), i = [], s = this.parsePattern(i, e);
            ...
            var e = this.scanner.index, t = this.scanner.lineNumber, r = this.scanner.lineStart;
            this.collectComments();
            ...
            var t = this.createNode(), r = this.nextToken().value;
            ...
            var r, i, n = this.createNode(), s = !1, a = !1, u = !1;
            ...
            var r = this.lookahead, i = this.parsePattern(e, t);
            if (this.match("=")) {
              this.nextToken();
            ...
            var t = this.createNode(), r = this.nextToken();
            ...
            var t = this.createNode(), r = [], i = this.parsePattern(r, "var");
            ...
            var e, t = this.createNode(), r = null;
            ...
            if (!this.match(")") && this.config.tolerant)this.tolerateUnexpectedToken(this.nextToken()), e = this.finalize(this.createNode(), new c.EmptyStatement); else {
              this.expect(")");
            ...
            var e, t, r = null, i = null, s = null, o = !0, a = this.createNode();
            ...
            var g;
            if (!this.match(")") && this.config.tolerant)this.tolerateUnexpectedToken(this.nextToken()), g = this.finalize(this.createNode(), new c.EmptyStatement); else {
              this.expect(")");
            ...
            var t = !this.match(";") && !this.match("}") && !this.hasLineTerminator && this.lookahead.type !== o.Token.EOF, r = t ? this.parseExpression() : null;
            ...
            var e, t = this.createNode(), r = this.parseExpression();
            ...
            var t = this.parseBlock(), r = this.matchKeyword("catch") ? this.parseCatchClause() : null, i = this.matchKeyword("finally") ? this.parseFinallyClause() : null;
            ...
            var e = this.createNode();
            this.expect("{");
            var t = this.parseDirectivePrologues(), r = this.context.labelSet, i = this.context.inIteration, n = this.context.inSwitch, s = this.context.inFunctionBody;
            ...
            if (t = {
                params: [],
                firstRestricted: e
              }, this.expect("("), !this.match(")"))for (t.paramSet = {}; this.startMarker.index < this.scanner.length && this.parseFormalParameter(t);)this.expect(",");
            return this.expect(")"), {params: t.params, stricted: t.stricted, firstRestricted: t.firstRestricted, message: t.message}
            ...
            var l = this.parseFormalParameters(o), h = l.params, p = l.stricted;
            o = l.firstRestricted, l.message && (i = l.message);
            var f = this.context.strict, d = this.parseFunctionSourceElements();
            ...
            var t = this.match("*");
            t && this.nextToken();
            var r, i, s = null, o = this.context.allowYield;
            ...
            var u = this.parseFormalParameters(i), l = u.params, h = u.stricted;
            i = u.firstRestricted, u.message && (r = u.message);
            var p = this.context.strict, f = this.parseFunctionSourceElements();
            ...
            var e = this.lookahead, t = null, r = this.createNode(), i = this.parseExpression();
            ...
            var t = !1, r = {params: [], stricted: null, firstRestricted: null, message: null}, i = this.context.allowYield;
            this.context.allowYield = !1;
            ...
            var e = this.createNode(), t = {params: [], firstRestricted: null, paramSet: {}}, r = !1, i = this.context.allowYield;
            ...
            var e = this.createNode(), t = !0, r = this.context.allowYield;
            this.context.allowYield = !0;
            ...
            var t, r, i, s = this.lookahead, a = this.createNode(), u = !1, l = !1, h = !1;
            ...
            var t = this.createNode(), r = this.context.strict;
            this.context.strict = !0, this.expectKeyword("class");
            var i = e && this.lookahead.type !== o.Token.Identifier ? null : this.parseVariableIdentifier(), n = null;
            ...
            this.context.strict = !0, this.expectKeyword("class");
            var r = this.lookahead.type === o.Token.Identifier ? this.parseVariableIdentifier() : null, i = null;
            ...
            var t = this.nextToken(), r = this.getTokenRaw(t);
            ...
            var t, r = [];
            if (this.lookahead.type === o.Token.StringLiteral)t = this.parseModuleSpecifier(); else {
            ...
            var e = this.createNode(), t = this.parseIdentifierName(), r = t;
        ...
        var r = function () {
          ...
          return e.prototype.recordError = function (e) {
            ...
            try {
              ...
              Object.create && Object.defineProperty && (r = Object.create(e), Object.defineProperty(r, "column", {value: t}))
            } finally {
              return r
            }
          }, e.prototype.createError = function (e, t, r, i) {
            var n = "Line " + t + ": " + i, s = this.constructError(n, r);
        ...
        var s = r(4), o = r(5), a = r(9), u = r(7), c = function () {
          function e(e, t) {
          ...
          return e.prototype.eof = function () {
            ...
            var t, r, i;
            for (this.trackComment && (t = [], r = this.index - e, i = {start: {line: this.lineNumber, column: this.index - this.lineStart - e}, end: {}}); !this.eof();) {
              ...
              if (++this.index, a.Character.isLineTerminator(n)) {
                if (this.trackComment) {
                  ...
                  var s = {multiLine: !1, slice: [r + e, this.index - 1], range: [r, this.index - 1], loc: i};
                  t.push(s)
                }
            ...
            if (this.trackComment) {
              ...
              var s = {multiLine: !1, slice: [r + e, this.index], range: [r, this.index], loc: i};
              t.push(s)
            }
            return t
          }, e.prototype.skipMultiLineComment = function () {
            var e, t, r;
            for (this.trackComment && (e = [], t = this.index - 2, r = {start: {line: this.lineNumber, column: this.index - this.lineStart - 2}, end: {}}); !this.eof();) {
              var i = this.source.charCodeAt(this.index);
              if (a.Character.isLineTerminator(i))13 === i && 10 === this.source.charCodeAt(this.index + 1) && ++this.index, ++this.lineNumber, ++this.index, this.lineStart = this.index; else if (42 === i) {
                if (47 === this.source.charCodeAt(this.index + 1)) {
                  if (this.index += 2, this.trackComment) {
                    ...
                    var n = {multiLine: !0, slice: [t + 2, this.index - 2], range: [t, this.index], loc: r};
                    e.push(n)
                  }
                  return e
                }
            ...
            if (this.trackComment) {
              r.end = {line: this.lineNumber, column: this.index - this.lineStart};
              var n = {multiLine: !0, slice: [t + 2, this.index], range: [t, this.index], loc: r};
              e.push(n)
            }
            ...
            for (var t = 0 === this.index; !this.eof();) {
              ...
              if (a.Character.isWhiteSpace(r))++this.index; else if (a.Character.isLineTerminator(r))++this.index, 13 === r && 10 === this.source.charCodeAt(this.index) && ++this.index, ++this.lineNumber, this.lineStart = this.index, t = !0; else if (47 === r)if (r = this.source.charCodeAt(this.index + 1), 47 === r) {
                this.index += 2;
            ...
            var e = this.codePointAt(this.index), t = a.Character.fromCodePoint(e);
            this.index += t.length;
            var r;
            ...
            var e, t = this.index, r = 92 === this.source.charCodeAt(t) ? this.getComplexIdentifier() : this.getIdentifier();
            ...
            var e = {type: u.Token.Punctuator, value: "", lineNumber: this.lineNumber, lineStart: this.lineStart, start: this.index, end: this.index}, t = this.source[this.index];
            switch (t) {
              case"(":
              case"{":
            ...
            if ("e" === t || "E" === t)if (r += this.source[this.index++], t = this.source[this.index], "+" !== t && "-" !== t || (r += this.source[this.index++]), a.Character.isDecimalDigit(this.source.charCodeAt(this.index)))for (; a.Character.isDecimalDigit(this.source.charCodeAt(this.index));)r += this.source[this.index++]; else this.throwUnexpectedToken();
            ...
            for (var r = !1, i = ""; !this.eof();) {
              ...
              if ("\\" === n)if (n = this.source[this.index++], n && a.Character.isLineTerminator(n.charCodeAt(0)))++this.lineNumber, "\r" === n && "\n" === this.source[this.index] && ++this.index, this.lineStart = this.index; else switch (n) {
                case"u":
                case"x":
            ...
            var e = "", t = !1, r = this.index, i = "`" === this.source[r], n = !1, s = 2;
            for (++this.index; !this.eof();) {
              ...
              if ("$" === c) {
                ...
                e += c
              } else if ("\\" === c)if (c = this.source[this.index++], a.Character.isLineTerminator(c.charCodeAt(0)))++this.lineNumber, "\r" === c && "\n" === this.source[this.index] && ++this.index, this.lineStart = this.index; else switch (c) {
                case"n":
                  e += "\n";
                  break;
                case"r":
                ...
                case"x":
                  if ("{" === this.source[this.index])++this.index, e += this.scanUnicodeCodePointEscape(); else {
                    var l = this.index, h = this.scanHexEscape(c);
            ...
            return t || this.throwUnexpectedToken(), i || this.curlyStack.pop(), {
              ...
              value: {cooked: e, raw: this.source.slice(r + 1, this.index - s)},
              head: i,
              tail: n,
              lineNumber: this.lineNumber,
              lineStart: this.lineStart,
            ...
            for (var e = "", t = ""; !this.eof();) {
              ...
              if (++this.index, "\\" !== r || this.eof())t += r, e += r; else if (r = this.source[this.index], "u" === r) {
                ++this.index;
                var i = this.index;
                if (r = this.scanHexEscape("u"))for (t += r, e += "\\u"; i < this.index; ++i)e += this.source[i]; else this.index = i, t += "u", e += "\\u";
                this.tolerateUnexpectedToken()
              } else e += "\\", this.tolerateUnexpectedToken()
            }
            return {value: t, literal: e}
          }, e.prototype.scanRegExp = function () {
            var e = this.index, t = this.scanRegExpBody(), r = this.scanRegExpFlags(), i = this.testRegExp(t.value, r.value);
            return {
            ...
            if (this.eof())return {type: u.Token.EOF, lineNumber: this.lineNumber, lineStart: this.lineStart, start: this.index, end: this.index};
        ...
        var n, s = this && this.__extends || function (e, t) {
          ...
          }, o = r(9), a = r(7), u = r(3), c = r(12), l = r(13), h = r(10), p = r(14);
        !function (e) {
        ...
        var f = function (e) {
          ...
          return s(t, e), t.prototype.parsePrimaryExpression = function () {
            ...
            if (60 === e || 62 === e || 47 === e || 58 === e || 61 === e || 123 === e || 125 === e) {
              ...
              return {type: a.Token.Punctuator, value: t, lineNumber: this.scanner.lineNumber, lineStart: this.scanner.lineStart, start: this.scanner.index - 1, end: this.scanner.index}
            }
            if (34 === e || 39 === e) {
              ...
              return {type: a.Token.StringLiteral, value: s, lineNumber: this.scanner.lineNumber, lineStart: this.scanner.lineStart, start: r, end: this.scanner.index}
            }
            if (46 === e) {
              var c = this.scanner.source.charCodeAt(this.scanner.index + 1), l = this.scanner.source.charCodeAt(this.scanner.index + 2), t = 46 === c && 46 === l ? "..." : ".", r = this.scanner.index;
              return this.scanner.index += t.length, {type: a.Token.Punctuator, value: t, lineNumber: this.scanner.lineNumber, lineStart: this.scanner.lineStart, start: r, end: this.scanner.index}
            }
            if (96 === e)return {type: a.Token.Template, lineNumber: this.scanner.lineNumber, lineStart: this.scanner.lineStart, start: this.scanner.index, end: this.scanner.index};
            if (o.Character.isIdentifierStart(e) && 92 !== e) {
              ...
              return {type: n.Identifier, value: h, lineNumber: this.scanner.lineNumber, lineStart: this.scanner.lineStart, start: r, end: this.scanner.index}
            }
            ...
            var i = {type: n.Text, value: t, lineNumber: this.scanner.lineNumber, lineStart: this.scanner.lineStart, start: e, end: this.scanner.index};
            ...
            var e, t = this.createJSXNode(), r = this.parseJSXIdentifier();
            if (this.matchJSX(":")) {
              var i = r;
              this.expectJSX(":");
            ...
            var e = this.createJSXNode(), t = this.parseJSXAttributeName(), r = null;
            ...
            var e = this.createJSXNode();
            this.expectJSX("<");
            var t = this.parseJSXElementName(), r = this.parseJSXAttributes(), i = this.matchJSX("/");
            ...
            var r = this.parseJSXElementName(), i = this.parseJSXAttributes(), n = this.matchJSX("/");
            ...
            for (var e = []; !this.scanner.eof();) {
              var t = this.createJSXChildNode(), r = this.nextJSXText();
              if (r.start < r.end) {
                var i = this.getTokenRaw(r), n = this.finalize(t, new p.JSXText(r.value, i));
                e.push(n)
              }
            ...
            for (var t = []; !this.scanner.eof();) {
              ...
              var r = this.createJSXChildNode(), n = this.parseJSXBoundaryElement();
              if (n.type === l.JSXSyntax.JSXOpeningElement) {
                var s = n;
                if (s.selfClosing) {
                  var o = this.finalize(r, new p.JSXElement(s, [], null));
                  e.children.push(o)
                } else t.push(e), e = {node: r, opening: s, closing: null, children: []}
              }
              if (n.type === l.JSXSyntax.JSXClosingElement) {
                e.closing = n;
                var a = i(e.opening.name), u = i(e.closing.name);
            ...
            var e = this.createJSXNode(), t = this.parseJSXOpeningElement(), r = [], i = null;
            if (!t.selfClosing) {
              var n = this.parseComplexJSXElement({node: e, opening: t, closing: i, children: r});
        ...
        "use strict";
        var i = r(8), n = r(6), s = r(7), o = function () {
          function e() {
          ...
          return e.prototype.errors = function () {
            ...
            if (0 === this.buffer.length) {
              ...
              if (this.scanner.trackComment)for (var t = 0; t < e.length; ++t) {
                var r = e[t], i = void 0, n = this.scanner.source.slice(r.slice[0], r.slice[1]);
                i = {type: r.multiLine ? "BlockComment" : "LineComment", value: n}, this.trackRange && (i.range = r.range), this.trackLoc && (i.loc = r.loc), this.buffer.push(i)
              }
              if (!this.scanner.eof()) {
                var o = void 0;
    ...
    function n(e) {
      var t, r, i;
      if (t = e.toString(16).toUpperCase(), e <= 255)r = "x", i = 2; else if (e <= 65535)r = "u", i = 4; else {
    ...
    function u(e, t) {
      var r, i, n;
      for (r = 0, i = e.implicitTypes.length; r < i; r += 1)if (n = e.implicitTypes[r], n.resolve(t))return !0;
      return !1
    }
    ...
    function f(e, t, r, i, n) {
      var s, o, a = !1, u = !1, f = i !== -1, d = -1, m = p(e.charCodeAt(0)) && !c(e.charCodeAt(e.length - 1));
      if (t)for (s = 0; s < e.length; s++) {
        if (o = e.charCodeAt(s), !l(o))return le;
        m = m && h(o)
      } else {
        for (s = 0; s < e.length; s++) {
          if (o = e.charCodeAt(s), o === R)a = !0, f && (u = u || s - d - 1 > i && " " !== e[d + 1], d = s); else if (!l(o))return le;
          m = m && h(o)
        }
        u = u || f && s - d - 1 > i && " " !== e[d + 1]
      }
    ...
    function d(e, t, r, i) {
      e.dump = function () {
        ...
        var s = e.indent * Math.max(1, r), a = e.lineWidth === -1 ? -1 : Math.max(Math.min(e.lineWidth, 40), e.lineWidth - s), c = i || e.flowLevel > -1 && r >= e.flowLevel;
    ...
    function w(e, t, r) {
      var i, n, s, o, a, u = "", c = e.tag, l = Object.keys(r);
      for (i = 0, n = l.length; i < n; i += 1)a = "", 0 !== i && (a += ", "), s = l[i], o = r[s], A(e, t, s, !1, !1) && (e.dump.length > 1024 && (a += "? "), a += e.dump + ": ", A(e, t, o, !1, !1) && (a += e.dump, u += a));
      e.tag = c, e.dump = "{" + u + "}"
    }

    function E(e, t, r, i) {
      var n, s, o, u, c, l, h = "", p = e.tag, f = Object.keys(r);
      if (e.sortKeys === !0)f.sort(); else if ("function" == typeof e.sortKeys)f.sort(e.sortKeys); else if (e.sortKeys)throw new N("sortKeys must be a boolean or a function");
    ...
    function k(e, t, r) {
      var i, n, s, o, a, u;
      for (n = r ? e.explicitTypes : e.implicitTypes, s = 0, o = n.length; s < o; s += 1)if (a = n[s], (a.instanceOf || a.predicate) && (!a.instanceOf || "object" == typeof t && t instanceof a.instanceOf) && (!a.predicate || a.predicate(t))) {
        if (e.tag = r ? a.tag : "?", a.represent) {
          if (u = e.styleMap[a.tag] || a.defaultStyle, "[object Function]" === M.call(a.represent))i = a.represent(t, u); else {
    ...
    function A(e, t, r, i, n, s) {
      ...
      if (c && (a = e.duplicates.indexOf(r), u = a !== -1), (null !== e.tag && "?" !== e.tag || u || 2 !== e.indent && t > 0) && (n = !1), u && e.usedDuplicates[a])e.dump = "*ref_" + a; else {
        if (c && u && !e.usedDuplicates[a] && (e.usedDuplicates[a] = !0), "[object Object]" === o)i && 0 !== Object.keys(e.dump).length ? (E(e, t, e.dump, n), u && (e.dump = "&ref_" + a + e.dump)) : (w(e, t, e.dump), u && (e.dump = "&ref_" + a + " " + e.dump)); else if ("[object Array]" === o)i && 0 !== e.dump.length ? (v(e, t, e.dump, n), u && (e.dump = "&ref_" + a + e.dump)) : (b(e, t, e.dump), u && (e.dump = "&ref_" + a + " " + e.dump)); else {
          if ("[object String]" !== o) {
    ...
    function S(e, t, r) {
      var i, n, s;
      if (null !== e && "object" == typeof e)if (n = t.indexOf(e), n !== -1)r.indexOf(n) === -1 && r.push(n); else if (t.push(e), Array.isArray(e))for (n = 0, s = e.length; n < s; n += 1)S(e[n], t, r); else for (i = Object.keys(e), n = 0, s = i.length; n < s; n += 1)S(e[i[n]], t, r)
    }
    ...
    var B = r(44), N = r(45), I = r(70), P = r(47), M = Object.prototype.toString, O = Object.prototype.hasOwnProperty, L = 9, R = 10, U = 32, _ = 33, z = 34, j = 35, X = 37, J = 38, Y = 39, K = 42, W = 44, H = 45, q = 58, G = 62, V = 63, $ = 64, Z = 91, Q = 93, ee = 96, te = 123, re = 124, ie = 125, ne = {};
    ne[0] = "\\0", ne[7] = "\\a", ne[8] = "\\b", ne[9] = "\\t", ne[10] = "\\n", ne[11] = "\\v", ne[12] = "\\f", ne[13] = "\\r", ne[27] = "\\e", ne[34] = '\\"', ne[92] = "\\\\", ne[133] = "\\N", ne[160] = "\\_", ne[8232] = "\\L", ne[8233] = "\\P";
    var se = ["y", "Y", "yes", "Yes", "YES", "on", "On", "ON", "n", "N", "no", "No", "NO", "off", "Off", "OFF"], oe = 1, ae = 2, ue = 3, ce = 4, le = 5;
    e.exports.dump = F, e.exports.safeDump = T
  }, function (e, t) {
    e.exports = '---\nurl: "http://petstore.swagger.io/v2/swagger.json"\ndom_id: "#swagger-ui"\nvalidatorUrl: "https://online.swagger.io/validator"\noauth2RedirectUrl: "http://localhost:5000/api/docs/oauth2-redirect.html"\n'
  }])
});
